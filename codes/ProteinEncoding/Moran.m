...
%This function calculates the Moran descriptor (Dim 8*nlag)
...
for j=1:len
 ...
 for d=1:nlag
     if AD~=0
    result(temp)=len*AU(d)/AD;temp=temp+1;
     else
     result(temp)=0;
     end
 end
