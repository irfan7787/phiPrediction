...
% This function calculates the Normalized Moreau-Broto descriptor (Dim
% 8*nlag) by invoking function MoreauBroto
...
function [result]=Moreau_file(data,nlag)
